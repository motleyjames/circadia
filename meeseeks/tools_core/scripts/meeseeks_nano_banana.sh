...
# Usage: ./nano_banana.sh "prompt" [output.png] [--fast] [--size SIZE] [--aspect RATIO]
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo ""
            echo "Options:"
            echo "  --fast           Use Nano Banana 2 (gemini-3.1-flash-image-preview) for faster/cheaper generation"
            echo "  --super-fast     Use Nano Banana OG (gemini-2.5-flash-image) for cheapest/fastest generation"
