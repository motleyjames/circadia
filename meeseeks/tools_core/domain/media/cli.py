#!/usr/bin/env python3
"""
Meeseeks Generative Media CLI

Headless image generation for Mr. Meeseeks.

Usage:
    python -m tools_core.domain.media.cli "a cyberpunk city" output.png
    python -m tools_core.domain.media.cli "a red panda" panda.png --backend mflux --steps 8
    python -m tools_core.domain.media.cli --check  # Check available backends
...
def main():
    ...
    from . import generate_image, check_backends, GEN_MEDIA_AVAILABLE
