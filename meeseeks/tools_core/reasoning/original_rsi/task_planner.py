...
from llm_caller import call_gemini_pro, call_claude_opus
...
def gather_codebase_context(base_path: Path) -> str:
    ...
    # NOTE: services have been moved to services/ canonical directory
    key_dirs = [
        "legion-desktop-app/src",
        "services/legion-gateway",
        "services/legion-tools",
        "services/legion-opencode",
    ]
...
if __name__ == "__main__":
    ...
    goal = "Build out the target project - merge all components from archive into a working Electron app with Docker backend"
